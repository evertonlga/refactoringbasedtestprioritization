...
public class ErrorMessagesAcceptanceTest_4 extends MockObjectTestCase {
    ...
    public void testReportsFailureWhenStubReturnsWrongTypeOfResult() {
        ...
        try {
            ...
            assertStringContains("should report no return value", errorMessage, "mockWithTwoMethods: tried to return an incompatible value: expected a int but returned a java.lang.String");
            return;
        }
