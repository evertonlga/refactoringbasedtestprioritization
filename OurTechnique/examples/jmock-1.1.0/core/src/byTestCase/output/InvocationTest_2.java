...
public class InvocationTest_2 extends TestCase {

    public InvocationTest_2(String name) {
        super(name);
    }
    ...
    public void testConstructorInterpretsNullParameterValueArrayAsZeroArguments() {
        ...
        assertEquals("expected no parameters values", 0, invocation.parameterValues.size());
    }
}
