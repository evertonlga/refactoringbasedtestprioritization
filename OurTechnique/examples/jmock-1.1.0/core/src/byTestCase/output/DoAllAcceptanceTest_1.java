...
public class DoAllAcceptanceTest_1 extends MockObjectTestCase {
    ...
    public void testCanSpecifyMultipleStubsForOneInvocation() {
        ...
        mockCollector.expects(once()).method("addThingsTo").with(same(list)).will(doAll(addElement("1"), addElement("2"), addElement("3"), addElement("4")));
