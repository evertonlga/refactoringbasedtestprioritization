...
public class InvocationTest_6 extends TestCase {

    public InvocationTest_6(String name) {
        super(name);
    }
    ...
    public void testToStringWithStringArray() throws Exception {
        Invocation invocation = new Invocation(INVOKED, methodFactory.newMethod(METHOD_NAME, new Class[] { String[].class }, void.class, EXCEPTION_TYPES), new Object[] { new String[] { "arg1", "arg2" } });
