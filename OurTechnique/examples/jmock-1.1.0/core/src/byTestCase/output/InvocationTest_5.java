...
public class InvocationTest_5 extends TestCase {

    public InvocationTest_5(String name) {
        super(name);
    }
    ...
    public void testToStringWithTwoArguments() throws Exception {
        Invocation invocation = new Invocation(INVOKED, methodFactory.newMethod(METHOD_NAME, new Class[] { String.class, String.class }, void.class, EXCEPTION_TYPES), new Object[] { "arg1", "arg2" });
