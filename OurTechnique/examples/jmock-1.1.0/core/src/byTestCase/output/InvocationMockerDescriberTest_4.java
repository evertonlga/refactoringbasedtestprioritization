...
public class InvocationMockerDescriberTest_4 extends TestCase {
    ...
    public void testDescribesAdditionalMatchersWithAppropriatePunctuation() {
        ...
        assertEquals("EXPECTATION: METHOD-NAME( ARG1, ARG2 ), OTHER-MATCHER#1, OTHER-MATCHER#2, STUB", buffer.toString());
