...
public class InvocationTest_8 extends TestCase {

    public InvocationTest_8(String name) {
        super(name);
    }
    ...
    public void testMethodToStringWithNullArg() throws Exception {
        Invocation invocation = new Invocation(INVOKED, methodFactory.newMethod(METHOD_NAME, new Class[] { String.class }, void.class, EXCEPTION_TYPES), new Object[] { null });
