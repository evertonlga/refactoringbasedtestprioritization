...
public class InvokeCountMatcherTest_3 extends TestCase {
    ...
    public void testReportsNumberOfExpectedAndActualInvocationsInDescription() {
        ...
        assertTrue("should describe match", description.indexOf("expected " + COUNT + " times") >= 0);
        assertTrue("should report number of actual invocations", description.indexOf("invoked " + (COUNT - 1) + " times") >= 0);
    }
}
