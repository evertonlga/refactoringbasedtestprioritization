...
public class ArgumentsMatcherTest_3 extends TestCase {
    ...
    public void testNoMatchWhenTooFewArguments() throws Throwable {
        ArgumentsMatcher matcher = new ArgumentsMatcher(new Constraint[] { IsAnything.INSTANCE, IsAnything.INSTANCE, IsAnything.INSTANCE });
