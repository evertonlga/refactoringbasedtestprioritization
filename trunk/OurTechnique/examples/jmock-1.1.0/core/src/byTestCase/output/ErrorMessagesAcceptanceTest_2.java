...
public class ErrorMessagesAcceptanceTest_2 extends MockObjectTestCase {
    ...
    public void testShowsNoExpectationsStringWhenNoExpectationsSet() {
        ...
        try {
            ...
            assertStringContains("should report no expectations have been set", errorMessage, "No expectations set");
            return;
        }
